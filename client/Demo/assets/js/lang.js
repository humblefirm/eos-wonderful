...
$(document).ready(function () {
  ...
  $.lang.ko = {
      ...
      11: '<h4>우와! 대박!</h4><a name="faucet_val"></a> 코인이나 있네요! 축하해요! <br /> 이게 비트코인이었으면 좋을텐데 말이죠 ;D <br />지금 갖고 계신 COF 코인은 EOS 코인과 마찬가지로 소수점 4자리 까지 분리가 가능해요!<br />이제 내가 가진 코인을 좋아하는 대상에게 전송해 볼게요.<br /><strong>충격적이게도... 이 데모용 댑은 송금 기능 외에는 코인을 사용하는 기능이 없어요 T,T</strong><br /><a href="https://github.com/humblefirm/eos-wonderful/tree/master/client" target="_blank">직접 COF 코인을 사용하는 댑을 만들어보고 싶지 않나요?</a><br /><a href="https://blog.naver.com/onethefullplatform/221362170050" target="_blank">이오스 원더풀을 이용해 만든 댑이 이것 외에도 이미있어요! 커피코인 코코를 소개합니다!</a> <br />',
      12: '좋아하는 대상의 계좌를 모르신다구요?<br />제가 계좌를 안알려드렸군요. <br />제 계좌는 이거에요!<br />EOS6FBY9FrxBGXRFsZJJLahKD1LdifzHjhWw5AncPrhYea9awcYAW',
      ...
      15: '<h4>와! 잘했어요!</h4> <br />아쉽지만, <a href="https://bloks.io/account/eos1thefull1" target="_blank">댑의 모든 트랜잭션 기록</a>을 보여드리고 여기서 여정을끝내야겠어요.<br />만약 우리의 여정이 즐거웠다면, 앞으로도 이오스원더풀이 걸어갈 수 많은 여정에 동참해주세요. <br />언제까지나 기다리고 있을게요. 고생 많았어요. 안녕!<br />',
  ...
  $.lang.en = {
      0: 'Welcome to the trial version<br />of a real actual public blockchain based dApp platform <strong>EOS-Wonderful</strong>',
      ...
      11: '<h4>Wow! Surprise!</h4><a name="faucet_val"></a> You do have coins! Congrats! <br /> Too bad there not Bitcoins <br /> The current COF Coins, like EOS Coins displays up to 4 decimals points!<br /> How about transferring your coins to another person? <br /><strong> Unfortunately, this trial dApp is only limited to show how to transfer actual coins</strong><br /><a href="https://github.com/humblefirm/eos-wonderful/tree/master/client" target="_blank"> Wouldn’t you want to create more dApp’s utilizing COF coins?</a><br /><a href="https://blog.naver.com/onethefullplatform/221362170050" target="_blank">EOS-Wonderful has already started another dApp! Its called COCO Coffee Coin!</a> <br />',
      12: 'Maybe you don’t know whom you want to transfer your coins to?<br />Let me tell you my account. <br />This is my account!<br />EOS6FBY9FrxBGXRFsZJJLahKD1LdifzHjhWw5AncPrhYea9awcYAW',
      ...
      15: '<h4>Wow! Good job!</h4><br /> Unfortunately, <a href="https://bloks.io/account/eos1thefull1" target="_blank">Let me show you all of the dApp transactions to end this simple trial tutorial.<br /> If this tutorial was good, be a part of EOS-Wonderful and lets create more together! <br /> We will always be here waiting! Seeya~<br />',
      16: 'Wonderful Platform has created EOS-Wonderful and utilized this Blockchain service To provide a more safe, secure and additional services for SME’s, especially privately owned coffee shops! <br />Our COCO Coffee Coin has already reached out to over 100 Coffee Shops!',
      17: 'Blossom',
      18: 'Chatte',
      19: 'Vitamin',
      20: 'Kongdang',
