...
>	2. 서비스 제공자(개발자)아 소비해야 하는 필요 비용을 최소화한다.  
...
## 솔루션
비용 절감을 위해 계정을 생성하지 않는다. 하나의 계정을 모두가 공유하기 때문에 자원도 효율적으로 사용된다. 하나의 계정을 공유하면서 생기는 각종 문제를 해결하기 위해 이중 검증을 통해 사용자를 구별한다. 이중검증은 EOS-Wonderful 계정내에 스마트컨트랙으로 구현되어 있습니다.
