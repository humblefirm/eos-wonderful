...
$(document).ready(function () {
  ...
  $.lang.ko = {
      ...
      15: '<h4>앗! 저게 뭔가요?</h4>내가 보낸 코인 외에 약 1 WDF 코인이 Fee(수수료)로 바뀌었네요! <br />정상이니 너무 놀라지 마세요. 코인의 무차별적인 송금을 막기 위해 수수료로 홀딩된거에요! <br />마지막 전송 시점으로부터 8시간이 지나면 모든 수수료를 돌려 받을 수 있으니 걱정말아요. <br />아쉽지만, <a href="https://bloks.io/account/eos1thefull1" target="_blank">댑의 모든 트랜잭션 기록</a>을 보여드리고 여기서 여정을끝내야겠어요.<br />만약 우리의 여정이 즐거웠다면, 앞으로도 이오스원더풀이 걸어갈 수 많은 여정에 동참해주세요. <br />언제까지나 기다리고 있을게요. 고생 많았어요. 안녕!<br />',
